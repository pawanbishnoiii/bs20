-- Chronodeck spaced revision + compulsory reading schema.
-- Safe to paste into the Supabase/Lovable SQL editor and safe to run again.
BEGIN;
...
-- Upgrade installations where reading_checkins was created by an older migration.
